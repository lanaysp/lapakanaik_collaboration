                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="alamat_majelis">Alamat Lengkap Majelis *</label>
                        <textarea class="form-control" name="alamat_majelis" id="alamat_majelis" cols="30" rows="10" style="margin-top: 0px; margin-bottom: 0px; height: 84px;" required></textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="sejarah_majelis">Sejarah Singkat Majelis</label>
                        <textarea class="form-control" name="sejarah_majelis" id="sejarah_majelis" cols="30" rows="10" style="margin-top: 0px; margin-bottom: 0px; height: 84px;"></textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="layanan_majelis">Layanan Majelis</label>
                      <textarea class="form-control" name="layanan_majelis" id="layanan_majelis" cols="30" rows="10" style="margin-top: 0px; margin-bottom: 0px; height: 84px;"></textarea>
                    </div>
                  </div>
                </div>
