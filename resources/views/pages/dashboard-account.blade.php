              ...
              <div class="card-body">
                <div class="row">
                 ...
                 <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="address_one">Alamat Personal</label>
                      <input
                        type="text"
                        class="form-control"
                        id="address_one"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="address_two">Alamat Kantor</label>
                      <input
                        type="text"
                        class="form-control"
                        id="address_two"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="country">No Rekening</label>
                      <input
                        type="text"
                        class="form-control"
                        id="country"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="phone_number">Np Hp</label>
                      <input
                        type="text"
                        class="form-control"
                        id="phone_number"
