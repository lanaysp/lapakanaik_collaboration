...
@section('content')
  ...
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="nav-link detail active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Deskripsi</a>
    <a class="nav-link detail" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Komentar</a>
  </div>
</nav>
