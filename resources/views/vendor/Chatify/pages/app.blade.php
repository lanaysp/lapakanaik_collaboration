...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-users"></span> Jika ingin chat admin bisa hubungi Lapakanik Collaboration</a>
        ...
        <div class="m-body">
           ...
           <div class="@if($route == 'user') show @endif messenger-tab app-scroll" data-view="users">
               ...
               {{-- Favorites --}}
               <p class="messenger-title mt-5">Favorites</p>
           ...
           <div class="messenger-tab app-scroll" data-view="search">
                {{-- items --}}
                <p class="messenger-title">Majelis :</p>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <a href="#" class="user-name">{{ config('nama_majelis') }}</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
        ...
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Pilih obrolan untuk mulai berkirim pesan</span></p>
            </div>
            {{-- Typing indicator --}}
