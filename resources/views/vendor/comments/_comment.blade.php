                        ...
                        <form method="POST" action="{{ route('comments.update', $comment->getKey()) }}">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="message">Perbarui komentar Anda di sini:</label>
                                    <textarea required class="form-control" name="message" rows="3">{{ $comment->comment }}</textarea>
                                    {{-- <small class="form-text text-muted"><a target="_blank" href="https://help.github.com/articles/basic-writing-and-formatting-syntax">Penurunan harga</a> contekan.</small> --}}
                                </div>
                            </div>
